...
var __Jasmine_been_here_before = new WeakMap();

jasmine.Env.prototype.compareObjects_ = function(a, b, mismatchKeys, mismatchValues) {
    if (__Jasmine_been_here_before.get(a) === b && __Jasmine_been_here_before.get(b) === a) {
      return true;
    }

    __Jasmine_been_here_before.set(a,b);
    __Jasmine_been_here_before.set(b,a);
  ...
  __Jasmine_been_here_before.delete(a);
  __Jasmine_been_here_before.delete(b);
...
jasmine.PrettyPrinter.prototype.format = function(value) {
  ...
  } else if (__Jasmine_been_here_before.has(value)) {
      this.emitScalar('<circular reference: ' + (jasmine.isArray_(value) ? 'Array' : 'Object') + '>');
    } else if (jasmine.isArray_(value) || typeof value == 'object') {
      __Jasmine_been_here_before.set(value, true);
      if (jasmine.isArray_(value)) {
        this.emitArray(value);
      } else {
        this.emitObject(value);
      }
      __Jasmine_been_here_before.delete(value);
    } else {
      this.emitScalar(value.toString());
    }
  } finally {
